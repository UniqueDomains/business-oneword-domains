...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C253%20rows-8250df">
...
**Public extract:** 8,253 rows · **Live catalog:** 8,249 domains
...
- `business.csv` — public CSV extract (8,253 rows)
- `business.json` — public JSON extract (8,253 rows)
...
| ----------------------- | ------------------------------------------------ |
| 8,253-row public sample | 8,249 live domains                               |
...
> Unique Domains. *Available .BUSINESS One-Word Domains*. Version 2026-04-13. Public GitHub extract for the exact Unique Domains search represented by this repository.
